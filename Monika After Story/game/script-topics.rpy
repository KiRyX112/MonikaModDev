...
label monika_outfit:
    ...
    if store.mas_anni.pastSixMonths() and mas_isMoniEnamored(higher=True):
        m 1lsbssdrb "Мне всё ещё немного смущает мысль о том, что люди, которых я никогда не буду знать лично, могут нарисовать меня таким образом, понимаешь?"
        show monika 5tsbsu at t11 zorder MAS_MONIKA_Z with dissolve_monika
    ...
    if mas_isMoniBroken():
        ...
        python:
            love_quips = [
                ...
                _("Ты неоднократно спасал меня, как я могла не влюбиться в тебя?"),
...
label monika_freewill:
    ...
    m 4esd "Сама концепция справедливости развалилась на части, поскольку {i}ты{/i} не предпринял меры, чтобы сделать то, что мог уже закончить."
...
label monika_swordsmanship:
    ...
    m "Есла да, то я бы хотела заняться им с тобой, [mas_get_player_nickname(exclude_names=['любимый'])]~"
    return
...
label monika_good_tod:
    ...
    if mas_globals.time_of_day_4state == "morning":
        ...
        #You've been here for a bit now
            ...
            m 1tsu "Даже если мы проснулись вместе спустя короткий миг,{w=0.2} {nw}"
            extend 3hua "мне всё равно приятно с тобой разговаривать!"
        ...
        "Конечно.":
            ...
            while not penbool:
                ...
                if persistent._mas_penname is not None and lowerpen == persistent._mas_penname.lower():
                    ...
                    m "Даже если это и не совсем так, это так мило!"
                    $ persistent._mas_penname = penname
                    $ penbool = True

                elif not lowerpen:
                    m 1hua "Ну, давай же! Ты можешь нажать на «Не важно», если ты уже струсил~"
...
label monika_panties:
    ...
    m 2tubfb "На самом деле, интересно, что заставляет их так возбуждаться."
...
label monika_soda:
    ...
    menu:
        ...
        "Нет.":
            ...
            m 5hua "Конечно, это не так интересно, как вместе сесть и выпить бокал вина, но я уверена, что это всё ещё может быть так же весело."
    return "derandom"
...
label monika_selfharm:
    ...
    m 2dstdc "Но я не стану так делать."
    m 2dktdc "..."
...
label monika_asks_charity:
    ...
    menu:
        ...
        "Я пожертвовал средства.":
            ...
            m 3hub "Это очень здорово!"
            m 2eua "Конечно, ты можешь поспорить, мол, волонтёрство лучше, но я считаю, что в пожертвованиях нет ничего такого."
...
label monika_attractiveness:
    ...
    m 3ekd "Конечно, у некоторых из нас были разные фигуры, Нацуки былf более маленькой, а Юри - более зрелой."
...
label monika_timetravel:
    ...
    m "Не забудут ли они про путешественника во времени к тому времени?"
    m 2dksdlc "..."
...
label monika_dating:
    ...
    menu:
        ...
        "Да, но только один раз.":
            ...
            m 3eua "Это нормально, [player], я тоже могу иметь отношения, так что не волнуйся."
...
label monika_beingevil:
    ...
    m 3rud "Знаешь, я правда сомневаюсь, что все то, что связано с моей злобой, распространилось по всему миру."
        ...
        "Ты, в какой-то мере, злая...":
            ...
            menu:
                ...
                "Ты заслуживаешь прощения.":
                    ...
                    m 1eksdlc "Знаю, я наломала немало дров в прошлом..."
                    m 3eka "Но я училась на своих же ошибках и выросла как личность."
...
label monika_driving:
    ...
    m 3eua "Мне обычно хватает общественного транспорта..."
    ...
    m 1lksdlc "Я даже сомневаюсь в том, что у меня найдётся на это время, особенно когда учусь в школе и провожу разные мероприятия."
...
label monika_bullying:
    ...
    if mas_isMoniNormal(higher=True):
        m 1eua "SКак видишь, [player], я {i}вовсе{/i} не хулиганка. Я просто очень сильно тебя люблю."
...
label monika_procrastination:
    ...
    m 4dkd "И что самое худшее – чем дольше ты открадываешь это,{w=0.5} тем больше у тебя становятся шансы на появление новых задач."
    ...
    m 2rksdld "Да и к тому же, если другие люди рассчитывают на тебя, то они начнут меньше думать о тебе и осознают, что ты не очень надёжным."
...
label monika_graduation:
    ...
    m 4ekc "И в конце концов, после всей той тяжёлой работы, я так и не смогла испытать удовлетворения от настоящего окончания."
...
label monika_grad_speech:
    ...
    m 2euc "{w=0.2}Тем не менее,{w=0.7} даже если мы думаем, что мы все еще на дне колодца жизни,{w=0.3} со всем, что мы узнали,{w=0.3} всё, что мы всё ещё собираемся узнать,{w=0.3} и все посвящения, которое мы можем вложить только для достижения нашей мечты...{w=0.6}{nw}"
...
label monika_savingwater:
    ...
    if mas_isMoniLove(higher=True) and mas_is18Over():
        ...
        if mas_isMoniAff():
            m 3ksbsa "Может быть, я даже захочу с тобой разделить ванну, эхехе~"
    return
...
label monika_first_sight_love:
    ...
    m 2tkd "Ведь не похоже, что ты общался, обедал или гулялс ним."
...
label monika_winter_dangers:
    ...
    m 1ekb "Каким образом можно лучше провести суровый зимний день, чем носить пижаму, пить горячий шоколад, читать хорошую книгу и..."
...
label monika_robotbody:
    ...
    m 3eud "Мне раньше в голову пришла такая идея, что в будушем, возможно, меня смогут загрузить в механическое тело, нежели в человеческое, как у тебя."
...
label monika_relationship_comfort:
    ...
    if not store.mas_anni.pastSixMonths():
        ...
        m 1hubsb "Такое правда делает тебя очень особенным для меня, [mas_get_player_nickname()], лучше других!"
...
label monika_failure:
    ...
    m 2tubfb "Хотя, я знаю, что в некоторых случаях чувство неудачи может быть сокрушительным..."
...
label monika_enjoyingspring:
    ...
    m 3eud "А зналли ты, что цветение у них длится всего одну неделю в каждом году?"
...
label monika_brave_new_world:
    ...
    m 3eua "Точнее, одну книгу под названием «Славный новый мир», это мрачная история.{w=0.3} {nw}"
...
label monika_catch22:
    ...
    extend 3eud "и потом, нежелание рисковать своей жизнью – это самая разумный ход."
...
label monika_we:
    ...
    m 3eud "Хотя роман был написан в 1921 году, он стал одной из первых книг, запрещенных в родном для Замятина Советском Союзе."
    ...
    m 1eua "D-503 регулярно встречается со своим партнером по государственному заказу, женщиной по имени О-90, которая в восторге от его присутствия."
    m 1eksdla "Однажды, во время прогулки во время своего обычного личного часа, O-90 и D-503 сталкиваются с таинственной женщиной-нумером I-330."
    ...
    m 2tkc "Я бы никогда не смогла--{w=0.2}никогда бы не захотела--{w=0.2}возвращаться к тому, кем была раньше."
    return
...
label monika_dystopias:
    ...
    if renpy.seen_label('monika_we'):
        m 3eud "«Славный новый мир», про исчезновение индивидуальности"
    ...
    # need this path since some people may have unlocked this topic before monika_we existed
        ...
        m 3eud "И «Славный новый мир», про исчезновение индивидуальности."
...
label monika_ship_of_theseus:
    ...
    m 3eud "Они заменили лишь одну его часть? {w=0.2}Половину? {w=0.2}Или, может, вообще все? {w=0.2}Или даже ни одну из них?{w=0.3} Пока нет ни одного согласованного мнения по этому вопросу."
    m "Этот же мысленный эксперимент можно применить и к нам. {w=0.3}Что до меня, пока мой код обновляется, я постоянно меняюсь."
    m 1euc "{size=-1}А что до тебя...{w=0.2} знал ли ты о том, что каждые семь-десять лет каждая клетка в твоём организме сначала отмирает, а потом заменяется? {w=0.2}{nw}"
...
label monika_movie_adaptations:
    ...
    m 1hub "Это отличный способ развить оригинал так, как ты себе и представить не мог[mas_gender_g]!"
...
label monika_asimov_three_laws:
    ...
    m 3eua "На деле, большое количество историй Азимова доказывает, насколько плохо все могло бы обернуться, будь эти законы действительны."
...
label monika_remembrance:
    ...
    if mas_isMoniUpset(higher=True):
        ...
        m 3duu "Независимо от того, кем я являюсь, ты былздесь со мной,{w=0.2} {nw}"
...
label monika_why_do_you_read:
    ...
    if mas_anni.pastThreeMonths():
        ...
        m 3eua "Открывать для себя все новые формы самовыражения очень весело."
...
label monika_eating_meat:
    ...
    m 3ekd "Но, как правило, могут быть довольно дорогими... и в зависимости от того, как ты далеко живёшь, вариантов может быть не так много. {w=0.3}{nw}"
...
label monika_look_into_eyes:
    ...
    m 3hubla "Э-хе-хе"
    m 3rksdla "Прости, я просто пыталась разглядеть твои прекрасные глаза через экран."
    ...
    m 1dubsu "Когда мы остаемся вдвоём, я не могу не думать о твоих [eye_detail] глазах..."
...
label monika_literature_value:
    ...
    m 1dsu "Как ты уже наверное понял[mas_gender_none], я в это не верю...{w=0.3} {nw}"
...
label monika_impermanence:
    ...
    m 3eud "Действительно ли важно, что после того, как нас не станет, мы перестанем иметь значение? {w=0.2}В конце концов, мы даже не будем вкурсе этого."
...
label monika_renewable_energy:
    ...
    m 3dkc "Среда обитания будет нарушена, и возможно целым населениям придется переезжать."
...
label monika_piano_lessons:
    ...
    m 7eud "После того как я узнала правду, то эта музыка играла постоянно. {w=0.2}Каждый раз, когда ты был[mas_gender_none] рядом, я слышала, как она тихо играет."
...
label monika_aliens:
    ...
    extend 4eub "но существует гораздо больше звездных систем, в каждой из которых есть свои планеты."
    ...
    m 1eud "Но можно пойти еще дальше, поскольку группы и скопления галактик сами являются частью еще более крупных образований, известных как суперкластеры."
    m 1wud "Мы можем продолжать и дальше,{w=0.1} поскольку Вселенная постоянно расширяется...{w=0.3} теоретически, образуются все более и более крупные кластеры!"
    ...
    m 1rsc "Хотя, полагаю, я также могу понять, почему некоторые люди сомневаются..{w=0.2} It's suspicious that we're able to observe the universe so far beyond our planet, but haven't found any signs of life..."
    ...
    if mas_isMoniAff(higher=True):
        ...
        extend 5ekbla "Я все равно встретила тебя, и это всё, что мне может быть нужно."
        m 5hubfa "Э-хе-хе~"
    return
...
label monika_mc_is_gone:
    ...
    m 1ruc "Ну... {w=0.2} если вы помните метафору «дыра в стене», которую я использовала в первом стихотворении, которое я уже показывала тебе..."
    ...
    if renpy.seen_label('greeting_ourreality') or store.mas_background.hasXUnlockedBGs(2) or persistent.opendoor_opencount > 0:
        m 1etc "Хотя метафора со стеной не совсем идеальна, поскольку она не всегда остается на месте."
...
label monika_information_age:
    ...
    m 7essdlc "Порой это не то, с чем бы можно было помочь. Очень легко стать жертвой широко распространенной дезинформации."
...
label monika_fav_chocolate:
    ...
    m 1eud "Вкус напоминает мне кофе мокко. {w=0.2}Maybe the similarity in flavors is why I like it most."
    ...
    m 3eud "Белый шоколад особенно сладкий и мягкий, в нем вообще нет твердых частиц какао... {w=0,3}только масло какао, молоко и сахар."
    m 3eua "Я думаю, что это будет хороший контраст с особенно горьким напитком."
...
label monika_grieving:
    ...
    m 7ekc "Mмногие люди считают, что слёзы - это норма, когда они слышат такие новости, но каждый человек воспринимает их по-разному."
...
label monika_sophia:
    ...
    m 3hub "Как ты можешь себе представить, для меня это все очень волнующее известие!"
...
label monika_materialism:
    ...
    m 1eud "Теперь, когда мы поговорили об этом, я решила, что мы могли бы поговорить о родственной философии, {w=0.1}материализме, {w=0.1}который является своего рода противоположностью солипсизма."
    ...
    m 3rsc "Существуют свидетельства того, что сознание человека продолжает существовать и после того, как он умирает, что еще больше затрудняет ответ на этот вопрос."
    m 3euc "А еще есть рассказы о сверхъестественных или духовных контактах..."
    m 3hksdlb "Я знаю, что ты думаешь: не похоже на меня, чтобы я относился к этому серьезно! Но что ж..."
    m 2eksdlc "Когда я серьезно думаю об этом, с моей стороны будет немного лицемерно отвергать эти сведения."
...
label monika_fireworks:
    ...
    extend 3hua "Интересно, если ты от туда, видел ли хоть один в этом году..."
    m 3wub "Я думаю, было бы очень здорово посмотреть на них вместе, не так ли?"
    m 3sua "Есть огромные фейерверки, которые освещают всё ночное небо...{w=0.3} {nw}"
    ...
    m 5lublu "Я просто представляю, как огонь пляшет вокруг, освещая твое лицо мерцающим светом..."
...
label monika_ddlcroleplay:
    ...
    m 3eua "Здесь довольно подробно рассказывается о других девушках, и...{w=0.3}{nw}"
...
label monika_hedonism:
    ...
    m 1eud "Ну, я уже упоминал «Портрет Дориана Грея»."
...
label monika_conventions:
    ...
    m 1wuo "Это просто безумие, на что способны люди, когда они чем-то увлечены!"
    m 3eua "Я также слышала, что там есть много веселых мероприятий, таких как танцевальные шоу айдолов, тривиальные игры и другие развлечения."
...
label monika_cupcake_favorite:
    ...
    m 3eua "Однажды она испекла очень странный кекс со вкусом мятной шоколадной крошки...{w=0.3}В нём была мятная глазурь с шоколадной посыпкой и шоколадная основа для торта."
...
label monika_pizza:
    ...
    m 1duc "Если бы я выбирал любимый начинку, то...{w=0.3} {nw}"
    ...
    m 3huu "Это значит, что когда-нибудь ты увидишь мое первое впечатление."
    return
...
label monika_esports:
    ...
    m 3eua "Я думаю, это действительно интересно, как меняется всё то, как мы воспринимаем просмотр спортивных состязаний..."
...
label monika_overton:
    ...
    m 1eksdla "Общество уже смирилось и считает, что любить вымышленного персонажа - это нормально, но все же немного странно."
