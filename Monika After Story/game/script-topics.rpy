...
label monika_ship_of_theseus:
    ...
    m 1euc "{size=-1}А что до тебя...{w=0.2} знал ли ты о том, что каждые семьдесят лет каждая клетка в твоём организме сначала отмирает, а потом заменяется? {w=0.2}{nw}"
