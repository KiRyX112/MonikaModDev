...
label monika_ptod_tip005:
    ...
    m "Раз «d» здесь сразу уже {b}True{/b}, мы уже будем знать, что по крайней мере одно из сравнений в этом выражении {b}True{/b}. Поэтому полное выражение будет того же значения, а именно {b}True{/b}."
