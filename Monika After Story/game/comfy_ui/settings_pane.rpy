            ...
            vbox:
                ...
                hbox:
                    textbutton _("Ок"):
                        ...
                        xsize 100
                        action Show(screen = "dialog", message = "Чтобы внести изменения, перезапустите игру.", ok_action = Jump(apply_label))

                    textbutton _("Отключить"):
                        style "navigation_button"
                        xsize 100
                        action Show(screen = "dialog", message = "Чтобы внести изменения, перезапустите игру.", ok_action = Jump(disable_label))
