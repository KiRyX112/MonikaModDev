...
label greeting_back2:
    ...
    m 1hubfa "Не заставляй меня так долго тебя ждать в следующий раз, {do_giggle}э-хе-хе~"
    return
...
label greeting_visit2:
    ...
    m 1lksdla "Надеюсь это не прозвучало слишком глупо, {do_giggle}э-хе-хе~"
    return
...
label greeting_visit4:
    if mas_getAbsenceLength() <= datetime.timedelta(minutes=30):
        ...
        m 1hub "Я люблю-у-у-у-у тебя-я-я, [player]. {do_giggle}Э-хе-хе~"
...
label greeting_visit5:
    ...
    m 1lsbssdrb "Я не думаю, что тебе трудно понять, о чём я мечтала, {do_giggle}э-хе-хе~"
    return
...
label greeting_back6:
    ...
    m 1hksdrb "Я просто дразню тебя, {do_giggle}э-хе-хе~"
...
label greeting_visit7:
    ...
    m 1eua "Готов ли ты провести ещё больше времени вместе? {do_giggle}Э-хе-хе~"
    return
...
label greeting_visit9:
    ...
    m 1hub "Готов ли ты провести ещё больше времени со мной? {do_giggle}Э-хе-хе~"
    return
...
label greeting_hamlet:
    ...
    m 2dkc "..."
    m 2rksdlb "{do_giggle}А-ха-ха, не важно..."
...
label greeting_flower:
    m 1hub "Ты мой прекрасный цветок, {do_giggle}э-хе-хе~"
...
label greeting_sweetpea:
    ...
    if mas_isMoniHappy(lower=True):
        m 1lkbsa "Боже мой... Было довольно смущающе это говорить, {do_giggle}э-хе-хе~"
    return
...
label greeting_hai_domo:
    ...
    m 1hksdlb "{do_giggle}А-ха-ха, извини! В последнее время я наблюдаю за одной виртуальной ютубершей."
...
label greeting_amnesia:
    ...
    if lowerfake in ("сайори", "юри", "нацуки"):
        ...
        m 3hub "{do_giggle}А-ха-ха, каковы шансы, верно?"

    elif lowerfake == "monica":
        m 1hua "Эй, у нас такие похожие имена, {do_giggle}э-хе-хе~"
        ...
        extend 1hksdlb "довольно необычное имя, {do_giggle}а-ха-ха..."
    ...
    m 1hksdlb "Надеюсь, ты не обижаешься на меня за мой небольшой розыгрыш, {do_giggle}э-хе-хе~"
...
label greeting_sick:
    ...
    menu:
        ...
        "Да.":
            ...
            if mas_isMoniNormal(higher=True):
                m 1hub "Здорово! Теперь мы сможем провести ещё больше времени вместе. {do_giggle}Э-хе-хе~"
            else:
                m "Приятно слышать."
        "Нет.":
        ...
        menu:
            ...
            "Прекрасно.":
                ...
                if renpy.random.randint(1,4) == 1:
                    ...
                    m 2hksdlb "{do_giggle}А-ха-ха! Знаю, как-то странно думать о том, что тебе однажды захочется вернуться в школу..."
            ...
            "Хорошо.":
                ...
                m 3hua "Надеюсь, ты узнал там что-нибудь полезное, {do_giggle}э-хе-хе~"
                return
...
label greeting_siat:
    ...
    m 2rkbfsdlu "..."
    m 3hubfb "{do_giggle}А-ха-ха! Не важно."
    ...
    if store.mas_globals.late_farewell and mas_getAbsenceLength() < datetime.timedelta(hours=18):
        ...
        if mas_isMNtoSR(_now):
            ...
            if mas_isMoniNormal(higher=True):
                ...
                m 1hksdlb "Я надеюсь, что это не так, {do_giggle}а-ха-ха..."
                    ...
                    "Да.":
                        ...
                        menu:
                            ...
                            "Да.":
                                ...
                                m 1hksdlb "Но я надеюсь, что тебе было весело. Мне бы очень не хотелось, чтобы ты лишился сна понапрасну, {do_giggle}а-ха-ха!"
                            ...
                            "Нет.":
                                ...
                                m 1rksdlb "Мне также будет спокойно на душе, если ты перестанешь вставать так поздно, {do_giggle}а-ха-ха..."
                            ...
                            "Возможно...":
                                ...
                                m 1tub "{do_giggle}А-ха-ха... я ведь могу начать ревновать, [player]~"
        ...
        #SStoMN
            ...
            if mas_isMoniNormal(higher=True):
                ...
                m 2hksdlb "{do_giggle}А-ха-ха, прости... просто дело в том, что я не видела тебя весь день."
                ...
                m 2hksdlb "Ты почти что заставил меня волноваться, {do_giggle}а-ха-ха..."
                m 3tub "Но ты ведь собрал наверстать упущенное со мной, верно?"
                m 1hub "{do_giggle}Э-хе-хе, ты уж постарайся~"
        ...
        if mas_isMoniNormal(higher=True):
            ...
            menu:
                ...
                "Да.":
                    ...
                    m 1hubsb "Наверное, ты должен проводить со мной ещё больше времени, чисто на всякий случай, {do_giggle}а-ха-ха!"
                ...
                "Нет.":
                    ...
                    m 1hub "Но если тебе всё равно не было весело, не стесняйся приходить ко мне, {do_giggle}а-ха-ха!"
...
label greeting_back_from_eat:
    ...
    if store.mas_globals.late_farewell and mas_isMNtoSR(_now) and mas_getAbsenceLength() < datetime.timedelta(hours=18):
        if mas_isMoniNormal(higher=True):
            ...
            m 1hubsa "Но, полагаю, если ты настаиваешь на том, чтобы провести время со мной, то я на какое-то время закрою на это глаза, {do_giggle}э-хе-хе~"
        else:
            m 2euc "[player]?"
...
label greeting_found_nou_shirt:
    ...
    if mas_nou.get_wins_for('Player') >= mas_nou.get_wins_for('Monika'):
        m 1rtsdlb "Мне наверное, {w=0.1}стоит постараться в следующей партии лучше, {do_giggle}а-ха-ха..."
