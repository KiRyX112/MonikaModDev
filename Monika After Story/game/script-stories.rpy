...
label mas_scary_story_prison_escape:
    ...
    m 2tfc "Озлобленная и возмущённая своим положением, она решила, что не может всю свою жизнь провести в тюрьме. {w=0.2}Она стала придумывать способы побега."
    m 7eua "Со временем она сблизилась с одним из тюремных надзирателей."
    ...
    m 1eud "Она заберётся в гроб с телом умершего, пока надзиратель будет заполнять свидетельство о смерти."
    ...
    m 3euc "Она встала, взломала замок своей камеры и медленно пошла по коридору."
    m 3wud "Пару раз она чуть не попалась...{w=0.3} её сердце колотилось так быстро."
    m 3ekc "Она открыла дверь в затемнённую комнату, где хранились гробы, и незаметно нашла тот, в котором находился труп."
    m 3dkc "Осторожно забравшись в него, она задвинула крышку и стала ждать, когда придёт надзиратель и прибьёт крышку гвоздями."
    m 2eka "Вскоре она услышала шаги, а после стук молотка."
    m 4eksdlc "Хотя ей было очень неуютно находиться в гробу с мёртвым телом, но она знала, что с каждым гвоздём она на шаг ближе к свободе."
    m 2eud "Гроб подняли и отвезли на кладбище."
    m 2eksdlc "Она не издала ни звука, когда гроб с грохотом упал на дно могилы."
    m 4eksdlc "Наконец она услышала, как земля опускается на крышку деревянного гроба, {w=0.1}{nw}"
    extend 4eksdla "и она понимала, что это лишь вопрос времени, когда она наконец-то станет свободной."
    m 2hksdlb "После часа абсолютной тишины она начала тихо хихикать про себя."
    m 2eta "Чувствуя любопытство, она решила зажечь спичку, чтобы выяснить личность мёртвого заключённого рядом с ней."
    m 2wusdld "...!"
