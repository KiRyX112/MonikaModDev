        ...
        if _return == "monika_short_stories_menu":
            ...
            if story_to_push == mas_stories.UNLOCK_NEW:
                if not can_unlock_story:
                    ...
                    m 1ekc "Извини, [player]... я не могу придумать новую [_story_type] историю прямо сейчас..."
...
label mas_story_tyrant:
    ...
    m "Он обвинил его в том, что он надоедал всем, кукарекая по утрам; не давал людям спать."
    ...
    m 1hksdrb "После этого, он приготовил завтрак из Петуха."
...
label mas_story_grasshoper:
    ...
    m 1hub "{do_giggle}Э-хе-хе, я так сильно тебя люблю, [player]!"
    return "love"
...
label mas_story_gray_hair:
    ...
    m 3rksdla "Поэтому, каждую ночь она собирала седые волосы."
    m 3euc "Но старшая жена не хотела ошибочно быть принятой за его мать."
    ...
    m 1hksdlb "{do_giggle}Э-хе-хе, я люблю тебя~!"
    return "love"
...
label mas_story_crow_and_pitcher:
    ...
    m 2esa "Но с каждым камешком вода поднималась всё выше и выше, и наконец..."
    m 4hub "Он смог сделать долгожданный, освежающий глоток!"
    m 2dka "..."
...
label mas_story_knock:
    ...
    m 3rud "...Раздался стук в дверь."
    m 3duc "Кто-то может сказать, что на этом история заканчивается.{w=0.2} {nw}"
    extend 1dud "Но в действительности это не так."
    ...
    m 7euc "Уолтер знал, что он говорил про змею и утку, чьи жизни унесла смерть."
    ...
    m 1dsc "Уолтер думал, что уже никогда не встретит ту самую единственную женщину...{w=0.3} {nw}"
    extend 1wub "но встреча с ней стала удивительным поворотом событий!"
    m 1esa "Грейс Эванс, последняя женщина на Земле, была удивлена, узнав то, что выяснил Уолтер.{w=0.2} Инопланетный организм не может умереть от естественных причин."
    m 3ttu "...Но, возможно, их можно убить."
    m 1eud "У мужчины было все необходимое для проверки этой теории, и, попрощавшись с Грейс, он привёл свой план в действие."
    m 3esc "Он попросил Зана показать последнюю утку, поскольку вторая погибла и рассказал пришельцу, что ему следует делать."
    m 4eud "«Поделитесь с ним любовью, погладьте его, иначе он тоже умрёт... {w=0.2}от одиночества.»"
    m 3rsc "Пришелец не понимал, что это значит, поэтому он просто наблюдал, как Уолтер с любовью гладит утку."
    m 1esc "«Проделайте то же самое с последней змеёй.» – сказал он."
    ...
    m 1euc "Так, Зан, которому было поручено погладить оставшуюся змею, был убит её смертельным ядом."
    m 1wud "Другой Зан вошёл в комнату Уолтера в отчаянии на следующий день. {w=0.2}{nw}"
    extend 4wko "«Один из нас умер!» – заплакал он."
    m 2dud "«К сожалению, ваш собрат покинул вас навсегда».{w=0.2} {nw}"
    extend 2esc "«Смертельная болезнь распространяется, вам нужно бежать» – заявил мужчина."
    m 7euc "Зан собрал совет и сообщил, что они действительно уходят."
    ...
    m 3gsbsu "Нам остаётся только фантазировать..."
...
label mas_scary_story_gray_lady:
    ...
    m 2eud "Во время одной из экспозиций своего отца он спас красивую женщину и в конце концов решил оставить свою прежнюю жизнь и женился на ней."
    m 2esa "Пара арендовала поместье неподалёку от того места."
    m 2hub "Они наслаждались счастливой семейной жизнью, но особенно радовались, когда родилась их дочь Кейт."
    m 4esa "С течением лет, Кейт выросла жизнерадостной молодой девушкой."
    m 2ekc "Уильям втайне стыдился того, что у него не хватало денег на покупку поместья, чтобы предложить его в качестве приданого тому, кто женится на его дочери."
    m 4hub "Потом в один прекрасный день, Кейт познакомилась и влюбилась в ирландского капитана пиратов, и они поженились."
    m 4esb "Счастливая пара решила поселиться в Дублине, поскольку у родителей Кейт не было собственной земли, которую они могли бы предложить."
    m 4eua "Кейт обещала вернуться и навестить своих родителей."
    m 4esd "Время шло, и Уильям вместе со своей женой начали сильно скучать по своей дочери и хотели, чтобы она вернулась."
    m 2dkc "Уильям решил вернуться к своим прежним занятиям на некоторое время, чтобы раздобыть деньги, необходимые для покупки поместья и пригласить дочь и её мужа жить с ними."
    m 4wud "Однажды ночью, он грабил на берегу разбившийся корабль, во время сбора ценного на корабле, он заметил тяжело раненую женщину, лежащую на камнях перед ним."
    m 2wuc "Из-за полученных травм черты её лица были неузнаваемыми."
    m 2ekc "Уильям, сжалившись над ней, отнёс её обратно в поместье и сделал всё, что мог, дабы попытаться спасти ей жизнь, но женщина умерла, даже не придя в сознание."
    m 2eud "Пока они обыскивали её тело, пытаясь найти хоть какие-то подсказки к её личности..."
    m "..Они нашли маленький кошелёк, привязанный к её талии, в котором было достаточно золотых монет и драгоценностей, чтобы наконец-то купить особняк, который они взяли в аренду."
    m 2dsc "Через несколько дней Адмиралтейство обратилось к супругам с запросом о пропавшем пассажире с обломков судна, которым оказалась не кто иной, как их дочь."
    m 3dsd "Подавленные и пристыженные, родители заточили её останки в тайной комнате и уехали, чтобы больше никогда не возвращаться."
    call mas_scary_story_cleanup
    return
...
label mas_scary_story_flowered_lantern:
    ...
    m 1dsd "Хагивара был очень расстроен и сильно оплакивал её, произнёс молитвы и сжёг ладан для неё."
...
label mas_scary_story_flowered_lantern_2:
    ...
    m 1eua "Каждый из них рассказал другому, что доктор сообщил им о смерти совершенно другого человека."
    ...
    m 2euc "Но на этот раз, слуга Хагивары проснулся и услышал голос молодой женщины, который был ему незнаком."
    m 4esd "Охваченный любопытством, но он не хотел тревожить своего хозяина, поэтому он прокрался в его комнату и заглянул через небольшую щель в двери и заметил, что он разговаривал с молодой женщиной."
...
label mas_scary_story_prison_escape:
    call mas_scary_story_setup
    m 1ekd "Симпатичная женщина отбывала пожизненный срок в тюрьме за убийство."
    m 2tfc "Озлобленная и возмущённая своим положением, решила, что не может всю свою жизнь провести в тюрьме. {w=0.2}Она стала придумывать способы побега."
    m 7eua "Со временем ей удалось сблизилась с одним из тюремных надзирателей."
    m 3esc "В его обязанности входило хоронить всех умерших заключённых на кладбище за стенами тюрьмы."
    m 3esd "Когда кто-то из заключённых умирал, надзиратель звонил в колокол, который слышали все заключённые."
    m 3esc "Далее, он получает тело в своё распоряжение, помещает его в гроб, а после у себя в кабинете заполняет свидетельство о смерти."
    m 3esd "И только потом, он отвозит гроб на кладбище для дальнейшего захоронения."
    m 1euc "Зная этот распорядок, женщина разработала план побега и поделилась им с надзирателем..."
    m 1eud "В следующий раз, когда зазвонит колокол, она покинет свою камеру и проберётся в тёмную комнату, где хранятся гробы."
    m 1eud "Заберётся в гроб с телом умершего, пока надзиратель будет заполнять свидетельство о смерти."
    m 3euc "Надзиратель вернётся закалачивать крышку, вынесет гроб с ней за пределы тюрьмы и похоронит его."
    m 3euc "Женщина знала, что ей хватит кислорода, чтобы продержаться до вечера, прежде чем надзиратель вернётся под покровом темноты, откопает гроб и освободит её."
    m 2eksdlc "Надзиратель неохотно согласился на этот план, {w=0.1}{nw}"
    extend 4esa "но поскольку за эти годы они с женщиной стали хорошими друзьями, он согласился это сделать."
    m 2tsc "Женщина несколько месяцев ждала, пока кто-то из заключённых не умрёт."
    m 7dsc "Однажды ночью она спала в своей камере, когда услышала звон колокола."
    m 3euc "Воспользовавшись моментом, встала, взломала замок своей камеры и медленно пошла по коридору."
    m 3wud "Пару раз она чуть не попалась...{w=0.3} её сердце колотилось так быстро."
    m 3ekc "Ей удалось пробраться в затемнённую комнату, где хранились гробы, и незаметно нашла тот, в котором находился труп."
    m 3dkc "Осторожно забравшись в него, она задвинула крышку и стала ждать, когда придёт надзиратель и прибьёт крышку гвоздями."
    m 2eka "Вскоре у входа послышались шаги, а после над ней стук молотка."
    m 4eksdlc "Хотя ей было очень неуютно находиться в гробу с мёртвым телом, но знала, что с каждым гвоздём на шаг ближе к свободе."
    m 2eud "Гроб подняли и отвезли на кладбище."
    m 2eksdlc "Девушка не издала ни звука, когда гроб с грохотом упал на дно могилы."
    m 4eksdlc "Наконец она услышала, как земля опускается на крышку деревянного гроба, {w=0.1}{nw}"
    extend 4eksdla "и разумеется, что это лишь вопрос времени, когда она наконец-то вновь обретёт свободу."
    m 2hksdlb "После часа абсолютной тишины, у неё вырвался нервный смешок."
    m 2eta "Чувствуя любопытство, решила зажечь спичку, чтобы выяснить личность мёртвого заключённого рядом с ней."
    m 2wusdld "...!"
    m 2wusdlo "Это был тот самый надзиратель!"
    call mas_scary_story_cleanup
    return
