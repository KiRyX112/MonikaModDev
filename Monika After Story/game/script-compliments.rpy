...
label mas_compliment_awesome_2:
    m 1hua "А-ах, [player]~"
    m 1hub "Это так мило!"
    m 2tuu "Но я думаю, что ты более потрясающий."
...
label mas_compliment_cute_2:
    ...
    menu:
        "Встреча с тобой всегда греет мне душу!":
            ...
            m 1dkbfu "...Почти так же, как когда я представляю, что мы вместе в одной реальности." #Ребята, контекст чекайте, хватит переводить не опираясь на лор игры(мода)
...
label mas_compliment_cute_3:
    python:
        cute_quips = [
            ...
            _("Ты всегда будешь {F=моей}{M=моим} милашкой~"),
