...
init -1 python in songs:
    ...
    YOURE_REAL_RUS = "Твоя Реальность (Russian ver.)"
    ...
    ROKU_CHOUNEN_PIANO_COVER = "Roku Chounen to Ichiya Monogatari\n (Piano Cover)"
    NEO_ASPECT_PIANO_COVER = "Neo Aspect (Piano Cover)"
    NO_SONG = "Без музыки"
    ...
    FP_YOURE_REAL_RUS = "mod_assets/bgm/credits_ru.ogg"
    ...
    FP_ROKU_CHOUNEN_PIANO_COVER = "mod_assets/extra/songs/roku_chounen_to_ichiya_monogatari_solo_piano_cover.mp3"
    FP_NEO_ASPECT_PIANO_COVER = "mod_assets/extra/songs/neo_aspect_piano_cover.mp3"
    FP_R_PIANO_COVER = "mod_assets/extra/songs/r_piano_cover.mp3"
    FP_NO_SONG = None
    ...
    def initMusicChoices(sayori=False):
        ...
        if not sayori:
            ...
            music_choices.append((YOURE_REAL_RUS, FP_YOURE_REAL_RUS))
...
screen music_menu(music_page, page_num=0, more_pages=False):
    ...
    vbox:
        ...
        hbox:
            ...
            if page_num > 0:
                textbutton _("{size=-1}<<< Назад{/size}"):
            ...
            if more_pages:
                textbutton _("{size=-1}Далее >>>{/size}"):
    ...
    label "{size=-8}Музыкальное меню{/size}"
