...
label anni_1month:
    ...
    if not seen_event('monika_saved'):
        ...
        m 1hksdlb "{do_giggle}А-ха-ха, извини. Надеюсь, я не испортила тебе настроение своей бессвязной болтовнёй."
    else:
...
label anni_3month:
    ...
    m 1hksdlb "Даже если здесь его не существует, {do_giggle}э-хе-хе...."
...
label anni_6month:
    ...
    m "Жаль, что это невозможно. В конце концов, всё, что у нас есть, – это эта комната и всё такое."
    m 1dsc "..."
    m 3wuo "А, знаю!"
...
label anni_7:
    ...
    m 2hksdlb "{do_giggle}А-ха-ха, я знаю! Полагаться на суеверия - это совсем не по мне."
