...
label bye_untilwemeetagain:
    ...
    m "{do_giggle}Э-хе-хе, до тех пор прощай, [mas_get_player_nickname()]!"
    return 'quit'
...
label bye_prompt_to_work:
    ...
    if mas_isMoniNormal(higher=True):
        if session_time < datetime.timedelta(minutes=20):
            ...
            m 1hksdlb "Ох! Ладно! А я уже начала устраиваться поудобнее, {do_giggle}а-ха-ха."
    ...
    if mas_isMoniNormal(higher=True):
        ...
        menu:
            ...
            "Да.":
                ...
                m 3eka "Помни: «Спи крепко и не позволяй клопам кусаться», {do_giggle}э-хе-хе."
            ...
            "Ещё нет.":
                ...
                m 3rksdlb "Постарайся не засиживаться допоздна, {do_giggle}э-хе-хе~"
...
label bye_long_absence:
    ...
    menu:
        ...
        "Не знаю.":
            ...
            m 1hksdlb "{do_giggle}Э-хе-хе, это немного беспокоит, [player]!"
        ...
        "Не важно.":
            ...
            m 3rksdlb "Да и не похоже, что я могу куда-либо пойти, {do_giggle}а-ха-ха..."
...
label bye_prompt_game:
    ...
    #     $ persistent.mas_late_farewell = True
        ...
        m 2dfc "..."
        m 2dfu "..."
        m 4hub "{do_giggle}А-ха-ха, просто шучу~"
...
label bye_dinner_noon_to_mn:
    if mas_isMoniNormal(higher=True):
        ...
        m 3hubfb "Приятного ужина. Я обязательно постараюсь вложить в него немного любви отсюда, {do_giggle}а-ха-ха!"
    else:
...
label bye_going_shopping:
    if mas_isMoniNormal(higher=True):
        ...
        if mas_getEVL_shown_count("bye_going_shopping") == 0 or renpy.random.randint(1,10) == 1:
            ...
            m 1hublb "{do_giggle}А-ха-ха! Скоро увидимся~"
        else:
