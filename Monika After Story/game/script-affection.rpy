...
label mas_affection_apology:
    ...
    m 2lfc "Если тебе правда жаль, то оставь текстовый файл с названием «прости» в папке «characters»."
    m 2dfd "А до тех пор, прощай..."
    $ persistent._mas_affection_should_apologise = True
    return 'quit'

label mas_affection_noapology:
    m 2efd "Ты всё ещё не оставил текстовый файл с названием «прости» в папке «characters»."
