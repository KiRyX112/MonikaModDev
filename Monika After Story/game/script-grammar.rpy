...
label monika_gtod_tip003:
    ...
    m 3hub "Раз уж я показала тебе те два примера, ты определённо можешь это сделать, {do_giggle}а-ха-ха!"
...
label monika_gtod_tip005:
    ...
    m 3hksdlb "Это полное предложение... хоть и самое неоднозначное, {do_giggle}а-ха-ха!"
...
label monika_gtod_tip007:
    ...
    m 3hub "В большинстве случаев, похоже, люди просто используют {b}«кто»{/b}, не имея никакого желания понять разницу, {do_giggle}а-ха-ха."
...
label monika_gtod_tip008:
    ...
    m 3hub "Разумеется, оба варианта здесь справедливы, поэтому никакой путаницы для меня здесь не возникает, {do_giggle}а-ха-ха!"
