...
default persistent.msr_custom_bg = 'original'

image monika_day_room = ConditionSwitch(
    "persistent.msr_custom_bg=='original'", "mod_assets/location/spaceroom/spaceroom.png",
    "persistent.msr_custom_bg=='custom1'", "mod_assets/extra/spaceroom/custom1/spaceroom.png",
    "persistent.msr_custom_bg=='custom2'", "mod_assets/extra/spaceroom/custom2/1/spaceroom.png",
    "persistent.msr_custom_bg=='custom21'", "mod_assets/extra/spaceroom/custom2/2/spaceroom.png",
    "persistent.msr_custom_bg=='custom3'", "mod_assets/extra/spaceroom/custom3/spaceroom.png",
    "persistent.msr_custom_bg=='custom4'", "mod_assets/extra/spaceroom/custom4/spaceroom.png"
)

image monika_ss_room = ConditionSwitch(
    "persistent.msr_custom_bg=='original'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/location/spaceroom/spaceroom.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom1'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom1/spaceroom.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom2'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom2/1/spaceroom.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom21'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom2/2/spaceroom.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom3'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom3/spaceroom.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom4'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom4/spaceroom.png"), im.matrix.tint(0.93, 0.82, 0.78) )
)

image monika_room = ConditionSwitch(
    "persistent.msr_custom_bg=='original'", "mod_assets/location/spaceroom/spaceroom-n.png",
    "persistent.msr_custom_bg=='custom1'", "mod_assets/extra/spaceroom/custom1/spaceroom-n.png",
    "persistent.msr_custom_bg=='custom2'", "mod_assets/extra/spaceroom/custom2/1/spaceroom-n.png",
    "persistent.msr_custom_bg=='custom21'", "mod_assets/extra/spaceroom/custom2/2/spaceroom-n.png",
    "persistent.msr_custom_bg=='custom3'", "mod_assets/extra/spaceroom/custom3/spaceroom-n.png",
    "persistent.msr_custom_bg=='custom4'", "mod_assets/extra/spaceroom/custom4/spaceroom-n.png"
)

image monika_rain_room = ConditionSwitch(
    "persistent.msr_custom_bg=='original'", "mod_assets/location/spaceroom/spaceroom_rain.png",
    "persistent.msr_custom_bg=='custom1'", "mod_assets/extra/spaceroom/custom1/spaceroom_rain.png",
    "persistent.msr_custom_bg=='custom2'", "mod_assets/extra/spaceroom/custom2/1/spaceroom_rain.png",
    "persistent.msr_custom_bg=='custom21'", "mod_assets/extra/spaceroom/custom2/2/spaceroom_rain.png",
    "persistent.msr_custom_bg=='custom3'", "mod_assets/extra/spaceroom/custom3/spaceroom_rain.png",
    "persistent.msr_custom_bg=='custom4'", "mod_assets/extra/spaceroom/custom4/spaceroom_rain.png"
)

image monika_rain_room_ss = ConditionSwitch(
    "persistent.msr_custom_bg=='original'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/location/spaceroom/spaceroom_rain.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom1'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom1/spaceroom_rain.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom2'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom2/1/spaceroom_rain.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom21'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom2/2/spaceroom_rain.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom3'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom3/spaceroom_rain.png"), im.matrix.tint(0.93, 0.82, 0.78) ),
    "persistent.msr_custom_bg=='custom4'",im.MatrixColor( im.Composite((1280, 720), (0, 0), "mod_assets/extra/spaceroom/custom4/spaceroom_rain.png"), im.matrix.tint(0.93, 0.82, 0.78) ))

image monika_snow_room_day = ConditionSwitch(
    "persistent.msr_custom_bg=='original'", "mod_assets/location/spaceroom/spaceroom_snow.png",
    "persistent.msr_custom_bg=='custom1'", "mod_assets/extra/spaceroom/custom1/spaceroom_snow.png",
    "persistent.msr_custom_bg=='custom2'", "mod_assets/extra/spaceroom/custom2/1/spaceroom_snow.png",
    "persistent.msr_custom_bg=='custom21'", "mod_assets/extra/spaceroom/custom2/2/spaceroom_snow.png",
    "persistent.msr_custom_bg=='custom3'", "mod_assets/extra/spaceroom/custom3/spaceroom_snow.png",
    "persistent.msr_custom_bg=='custom4'", "mod_assets/extra/spaceroom/custom4/spaceroom_snow.png"
)

image monika_snow_room_night = ConditionSwitch(
    "persistent.msr_custom_bg=='original'", "mod_assets/location/spaceroom/spaceroom_snow-n.png",
    "persistent.msr_custom_bg=='custom1'", "mod_assets/extra/spaceroom/custom1/spaceroom_snow-n.png",
    "persistent.msr_custom_bg=='custom2'", "mod_assets/extra/spaceroom/custom2/1/spaceroom_snow-n.png",
    "persistent.msr_custom_bg=='custom21'", "mod_assets/extra/spaceroom/custom2/2/spaceroom_snow-n.png",
    "persistent.msr_custom_bg=='custom3'", "mod_assets/extra/spaceroom/custom3/spaceroom_snow-n.png",
    "persistent.msr_custom_bg=='custom4'", "mod_assets/extra/spaceroom/custom4/spaceroom_snow-n.png"
)
...
init 5 python:
    ...
    addEvent(
        Event(
            ...
            prompt="Мы можем пойти куда-нибудь ещё?",
            pool=True,
            unlocked=False,
...
label monika_change_background_loop:
    ...
    call mas_background_change (sel_background, skip_leadin=skip_leadin, skip_outro=skip_outro, set_persistent=True) from _call_mas_background_change_7
    return
...
label mas_background_change(new_bg, skip_leadin=False, skip_transition=False, skip_outro=False, set_persistent=False):
    ...
    call spaceroom (scene_change=True, dissolve_all=True, bg_change_info=change_info) from _call_spaceroom_23

    if not skip_outro:
        $ MAS.MonikaElastic()
        m 1eua "Вот мы и пришли!"
        $ MAS.MonikaElastic()
        m "Дай мне знать, если захочешь пойти куда-нибудь ещё, хорошо?"
    return
