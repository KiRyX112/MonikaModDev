...
label mas_island_cherry_blossom4:
    ...
    m "Немного сакэ~"
    m "{do_giggle}А-ха-ха! Я просто шучу."
...
label mas_island_day3:
    if mas_is_raining and not mas_isWinter():
        ...
        if mas_island_event.is_winter_weather():
            ...
            m "{do_giggle}А-ха-ха, это было бы так весело!"
            m "Бьюсь об заклад, я могла бы попасть в тебя через несколько островов отсюда."
...
label mas_island_daynight2:
    ...
    m "{do_giggle}Э-хе-хе, не обращай на меня внимания, я просто захотела спеть на ровном месте~"
    return
...
label mas_island_bookshelf2:
    ...
    if mas_island_event.is_winter_weather():
        ...
        m "Думаю, переворачивать страницы может быть немного трудно таким образом, {do_giggle}а-ха-ха..."
...
label mas_island_spooky_ambience:
    ...
    m "{do_giggle}Э-хе-хе~ Это идеальное время года для жутких историй, не правда ли?"
